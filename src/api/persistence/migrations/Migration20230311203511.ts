...
export class Migration20230311203511 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "requests" ("id" varchar(255) not null, "requester_id" varchar(255) not null, "title" varchar(255) not null, "description" varchar(255) not null, "creation_date" timestamptz(0) not null, "last_edition_date" timestamptz(0) not null, constraint "requests_pkey" primary key ("id"));');
